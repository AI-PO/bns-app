// src/app/home-views/bn/FinalCTA/FinalCTA.tsx
// For the APP repo: replace waitlist form with login CTA
    ...
    <div className="relative mx-auto max-w-[720px] px-5 lg:px-10 text-center">
      ...
      <RevealOnView delay={0.12}>
        <p className="bn-sub text-bn-text-2 mb-12 max-w-[520px] mx-auto">
          Create an account or connect your wallet to search, buy and manage
          your .btc name on Bitcoin.
        </p>
      </RevealOnView>
      ...
      <RevealOnView delay={0.2}>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            href="/marketplace"
            className="inline-flex items-center justify-center gap-2 bg-white/10 text-white font-medium text-[15px] px-8 py-4 rounded-full hover:bg-white/15 transition-colors border border-white/20"
          >
            Browse marketplace
          </Link>
        </div>
        <p className="mt-6 text-[13px] text-bn-text-muted">
          No wallet required to sign up · Connect when you&apos;re ready to buy
        </p>
      </RevealOnView>
    </div>
  </section>
